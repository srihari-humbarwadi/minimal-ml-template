...
def wideresnet28x18_evoaugment_cifar100_bs256_ep200_n25():
    dataset = Dataset(name='cifar100',
                      num_classes=100,
                      num_train_samples=50000,
                      num_val_samples=10000,
    ...
    config = Experiment(
        experiment_name='wideresnet28x18_evoaugment_cifar100_bs256_ep200_n25',
        experiment_dir='/home/srihari/exps/wideresnet28x18_evoaugment_cifar100_bs256_ep200_n25',
        model=WideResNet(num_classes=dataset.num_classes,
                         depth=28,
                         widen_factor=10,
                         dropout_rate=0.0),
        train_dataloader=Dataloader(
            ...
            augmentation=Augmentation(
                random_crop=RandomCrop(size=32, padding=4),
                cutout=CutoutDefault(length=16),
                evolution_augment=EvolutionAugment(
                    num_candidates=64, num_ops=2, magnitude=14)),
            is_training=True,
            num_workers=os.cpu_count() // 2),
        val_dataloaders=Dataloader(
            dataset=dataset,
